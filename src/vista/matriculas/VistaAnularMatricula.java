 ...
 * @author Novoa
 */
public class VistaAnularMatricula extends javax.swing.JFrame {
     ...
     */
    public VistaAnularMatricula() {
        initComponents();
        this.setLocationRelativeTo(null);
        this.disabledField();
    }
    
    public VistaAnularMatricula(Usuario usuario, Matricula matricula) {
        initComponents();
        this.setLocationRelativeTo(null);
        this.disabledField();
    ...
    void disabledField() {
        ...
        this.txt_emp.setEditable(false);
        this.txt_fec_anu.setEditable(false);
    }
    ...
    void llenarDatos(Matricula matricula) {
        ...
        this.txt_fec_anu.setText(sdt.format(new Date()));
        this.txt_emp.setText(usuario.toString());
    }
    
    void anular() {
        MatriculaControlador mc = new MatriculaControlador();
        MensajeRespuesta respuesta = mc.save(this.matricula.getId(), null, null,
                null, null, null, null, null, null, null,
                this.txt_motivo.getText(), new Date());
        if (!respuesta.getError()) {
            this.dispose();
            new VistaMatricula(this.usuario).setVisible(true);
            JOptionPane.showMessageDialog(rootPane, "Matricula Anulada correctamente.");
        }
    }
    ...
    private void initComponents() {
        ...
        txt_fec_anu = new javax.swing.JTextField();
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("Anular Matricula"));

        jLabel1.setText("Empleado");

        jLabel2.setText("Fecha");

        jLabel6.setText("Motivo de anulación");

        txt_motivo.setColumns(20);
        txt_motivo.setRows(5);
        jScrollPane2.setViewportView(txt_motivo);

        btn_anular.setText("Anular Matrícula");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txt_emp, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txt_fec_anu, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(63, 63, 63)
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabel2)
                    .addComponent(txt_fec_anu, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addGroup(jPanel4Layout.createSequentialGroup()
    ...
    private void btn_anularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_anularActionPerformed
        if (this.txt_motivo.getText().isEmpty()) {
            JOptionPane.showMessageDialog(rootPane, "Debe especificar el motivo por la cual desea Anular la Matrícula.");
        } else {
            this.anular();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaAnularMatricula.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaAnularMatricula().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField txt_fec_anu;
