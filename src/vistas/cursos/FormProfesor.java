...
import modelos.jtable.ProfesorTableModel;
...
public class FormProfesor extends javax.swing.JFrame {
    ...
    void buscarProfesor() {
        this.ptm = new ProfesorTableModel(this.pc.index(this.txt_bus.getText()));
        this.tbl_datos.setModel(ptm);
    }
    
    void seleccionarProfesor() {
        int fila = this.tbl_datos.getSelectedRow();
        if (fila >= 0) {
            VistaCurso.seleccionarProfesor(this.ptm.getProfesorAt(fila));
            this.dispose();
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Seleccionar Profesor"));
